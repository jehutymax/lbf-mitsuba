...
int FeatureSampler::numOfBuffers;
int* FeatureSampler::featureInd;
int* FeatureSampler::pixelSampleCount;
size_t FeatureSampler::width;
size_t FeatureSampler::height;
size_t FeatureSampler::spp;
size_t FeatureSampler::numOfSamples;
SampleElem* FeatureSampler::pixelData;
SampleElem* FeatureSampler::texture2Data;
SampleElem* FeatureSampler::sampleMean;
SampleElem* FeatureSampler::varData;
SampleElem** FeatureSampler::pixelBuffer;

void FeatureSampler::Initialize(size_t imgWidth, size_t imgHeight, size_t imgSamplesPerPixel) {
...
void FeatureSampler::GenerateBufferIndex(int& bufInd, float& bufNormFactor, int n) {
...
void FeatureSampler::ProcessTexture2Data() {
...
void FeatureSampler::SaveRenderTime(char* fileName, char* inputFolder, char* sceneName, Timer& timer) {
...
void FeatureSampler::ProcessData(char* fileName, Timer timer) {
	...
	LBF(inputFolder, sceneName, pixelData, varData, pixelBuffer, width, height, spp, (float) timer.Time()); 

}

bool FeatureSampler::ShouldSaveFeature(size_t x, size_t y, size_t k) {
...
SampleElem FeatureSampler::GetFeature(size_t x, size_t y, size_t k, OFFSET offset) {
	bool saveSample;
...
SampleElem FeatureSampler::GetFeature(size_t index, bool isTexture2) {
	if(!isTexture2) {
...
size_t FeatureSampler::GetWidth() {
	return width;
}

size_t FeatureSampler::GetHeight() {
	return height;
}

size_t FeatureSampler::GetSamplesPerPixel() {
	return spp;
}

size_t FeatureSampler::GetNumOfSamples() {
	return numOfSamples;
}

size_t FeatureSampler::GetIndex(size_t x, size_t y, size_t& k, bool& saveSample) {
...
int FeatureSampler::GetPixelCount(size_t x, size_t y) {
...
void FeatureSampler::SetPosition(size_t x, size_t y, size_t k, SampleElem position, OFFSET offset) {
...
void FeatureSampler::SetPosition(size_t index, SampleElem position, bool saveSample, int n, size_t x, size_t y, OFFSET offset) {
...
void FeatureSampler::SetColor(size_t x, size_t y, size_t k, SampleElem color, OFFSET offset) {
...
void FeatureSampler::SetColor(size_t index, SampleElem color, bool saveSample, int n, size_t x, size_t y, OFFSET offset) {
...
void FeatureSampler::SetFeature(size_t x, size_t y, size_t k, SampleElem feature, OFFSET offset) {
...
void FeatureSampler::SetFeature(size_t index, SampleElem feature, bool saveSample, int n, size_t x, size_t y, OFFSET offset) {
...
void FeatureSampler::SetWidth(size_t newWidth) {
	width = newWidth;
	numOfSamples = width * height;
}

void FeatureSampler::SetHeight(size_t newHeight) {
	height = newHeight;
	numOfSamples = width * height;
}

void FeatureSampler::SetSamplesPerPixel(size_t newSamplesPerPixel) {
