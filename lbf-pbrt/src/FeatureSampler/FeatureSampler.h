#ifndef	FEATURESAMPLER_H_INCLUDED
#define FEATURESAMPLER_H_INCLUDED
...
class SAMPLER_API FeatureSampler {

public:

	static void Initialize(size_t width, size_t height, size_t samplesPerPixel);
	static void ProcessData(char* sceneName, Timer renderTimer);
...
private:
	...
	static void SaveRenderTime(char* sceneName, char* inputFolder, char* name, Timer& timer);
